            ...
            <fieldset class="layui-elem-field">
                <div class="layui-field-box" style="height: 500px;background-color: white">
                    ...
                    <div align="center" style="font-size: 20px">
                        <img src="${hostImage}" style="width: 200px; height: 200px" ><br/>
                        ${hostName}
                    </div>
                    <br/>
                    <br/>
            ...
            <fieldset class="layui-elem-field">
                <div class="layui-field-box" style="min-height: 500px;background-color: white">
                    <p style="font-size: 20px">${host.topicTitle}
                        <c:if test="${host.digest==1}">
                            &nbsp;&nbsp;<span class="layui-badge">精</span>
                        </c:if>
                    </p>
                    <br/>
                    <blockquote class="layui-elem-quote layui-quote-nm">
                        发表于：<fmt:formatDate value="${host.createTime}" type="both" dateStyle="medium" timeStyle="medium"/>
                        <div style="float: right">
                            浏览数：${host.topicViews}
                        </div>
                    </blockquote>
                    &nbsp;&nbsp;  ${hostText}
                    <c:if test="${user.userType==2||host.userId==user.userId}">
                        <form action="/toUpdate" method="post" style="position:absolute;right:0px;bottom:25px;width:50px;">
                            <input type="hidden" name="_method" value="POST">
                            <input type="hidden" name="userId" value="${host.userId}">
                            <input type="hidden" name="topicId" value="${host.topicId}">
                            <input type="submit" class="layui-btn-xs layui-btn" value="修改">
                        </form>
                    </c:if>
                </div>
        ...
        <div class="layui-col-md3">
            <fieldset class="layui-elem-field">
                <div class="layui-field-box" style="min-height: 300px;background-color: white">
                    ...
                    <br/>
                    <div align="center" style="font-size: 20px">
                        <img src="${p.imagePath}" style="width: 200px; height: 200px" ><br/>
                            ${p.postTitle}
                    </div>
                    <br/>
                    <br/>
